...
## 13.2 Introducing temperature {#introducing-temperature}

### 13.2.1 Temperature and heat capacity {#temperature-and-heat-capacity}
...
![image](../images/2024_09_14_9969b06773f10b6936e8g-324.jpg)
...
### 13.2.2 The gas thermometer {#the-gas-thermometer}
...
![image](../images/2024_09_14_9969b06773f10b6936e8g-326.jpg)
...
### 13.2.3 The zero-th law {#the-zero-th-law}
...
## 13.3 Heat and the first law {#heat-and-the-first-law}

### 13.3.1 \"Direct exchange of thermal energy\" and early theories of heat {#direct-exchange-of-thermal-energy-and-early-theories-of-heat}
...
### 13.3.2 The first law of thermodynamics {#the-first-law-of-thermodynamics}
...
## 13.4 The second law and entropy {#the-second-law-and-entropy}
...
### 13.4.2 The efficiency of heat engines {#the-efficiency-of-heat-engines}
...
### 13.4.3 But what IS entropy, anyway? {#but-what-is-entropy-anyway}
...
6.  The work done on (or by) a system by (or on) its environment, plus the heat given to (or taken from) the system by its environment, always equals the net change in the system's total energy (conservation of energy, or first law of thermodynamics; Eq. (13.8)).
...
## 13.6 Examples {#examples}

### 13.6.1 Calorimetry {#calorimetry}
...
### 13.6.2 Equipartition of energy {#equipartition-of-energy}
