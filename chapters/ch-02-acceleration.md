...
## 2.1 The law of inertia {#the-law-of-inertia}
...
### 2.1.1 Inertial reference frames {#inertial-reference-frames}
...
## 2.2 Acceleration {#acceleration-1}

### 2.2.1 Average and instantaneous acceleration {#average-and-instantaneous-acceleration}
...
![image](../images/2024_09_14_9969b06773f10b6936e8g-054.jpg)
...
![image](../images/2024_09_14_9969b06773f10b6936e8g-055.jpg)
$a<0$
...
![image](../images/2024_09_14_9969b06773f10b6936e8g-056.jpg)

Figure 2.3: Sample position, velocity and acceleration vs. time graphs for motion with piecewise-constant acceleration.

### 2.2.2 Motion with constant acceleration {#motion-with-constant-acceleration}
...
![image](../images/2024_09_14_9969b06773f10b6936e8g-058.jpg)
...
### 2.2.3 Acceleration as a vector {#acceleration-as-a-vector}
...
### 2.2.4 Acceleration in different reference frames {#acceleration-in-different-reference-frames}
...
8.  The basic equations used to describe motion with constant acceleration are (2.4), (2.7) and (2.10) above. Alternative forms of these are also provided in the text.
...
### 2.5.1 Motion with piecewise constant acceleration {#motion-with-piecewise-constant-acceleration}
